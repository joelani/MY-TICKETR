...
export default function Features() {
  return (
    <section className="mt-34 mb-24 z-20">
      <h1 className="text-5xl max-md:text-4xl text-gray-800 font-semibold text-center mx-auto">
        Create Tickets
      </h1>
      ...
      <div className="flex items-center justify-center flex-wrap gap-6 mt-20 px-4 md:px-0 z-20 backdrop-blur-2xl">
        <div className="flex flex-col backdrop-blur-2xl text-center items-center justify-center rounded-xl p-6 border border-orange-200 gap-6 max-w-sm">
        ...
        <div className="flex flex-col backdrop-blur-2xl text-center items-center justify-center rounded-xl p-6 border border-green-200 gap-6 max-w-sm">
