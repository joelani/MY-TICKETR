<template>
  <h1
    className="text-4xl max-md:text-4xl text-gray-800 font-semibold text-center mt-24 mx-auto z-50"
  >
    Create Tickets
  </h1>
  <p className="text-sm text-gray-600 text-center mt-2 max-w-md mx-auto z-50">
    Easily submit new tickets with a simple form and smart validation.
  </p>

  <div class="flex items-center justify-center flex-wrap gap-6 mt-20 px-4 md:px-0 z-50">
    <div
      class="flex flex-col backdrop-blur-2xl text-center items-center justify-center rounded-xl p-6 border border-violet-200 gap-6 max-w-sm"
    >
    ...
    <div
      class="flex flex-col backdrop-blur-2xl text-center items-center justify-center rounded-xl p-6 border border-green-200 gap-6 max-w-sm"
    >
    ...
    <div
      class="flex flex-col backdrop-blur-2xl text-center items-center justify-center rounded-xl p-6 border border-orange-200 gap-6 max-w-sm"
    >
